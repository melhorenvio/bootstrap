    ...
    return function( oStyle ) {
        var fCaniuseMethod = function( sFeature ) {
            ...
            for( ; sBrowserSupportVar = aBrowsersSupportVars[ ++i ] ; ) {
                mBrowserSupportVarValue = this.global.scope.lookup( "me-support-" + sBrowserSupportVar ) ? this.global.scope.lookup( "me-support-" + sBrowserSupportVar ).first.val : false;;
        ...
        oStyle.define( "me-caniuse-prefixes", fCaniuseMethod );
        if( !( this.evaluator.global.scope.lookup( "me-no-conflict" ) ? this.evaluator.global.scope.lookup( "me-no-conflict" ).first.val : false ) ) {
